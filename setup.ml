...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9b5520e9b06359f435943e806499e622) *)
(*
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({cs_name = "oUnit"; cs_data = PropList.Data.create (); },
                   {
               ...
               Doc
                 ({cs_name = "api-ounit"; cs_data = PropList.Data.create (); 
                  },
                   {
               ...
               Flag
                 ({cs_name = "backtrace"; cs_data = PropList.Data.create (); 
                  },
                   {
                      flag_description =
