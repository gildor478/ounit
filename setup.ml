...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3a374a4ba75b82b85d7a0efb176ab2f8) *)
(*
     ...
     package =
       {
            ...
            [
               ...
               Doc
                 ({
                   ...
                   {
                      doc_type = (`Doc, "ocamlbuild", Some "0.2.0~alpha1");
                      doc_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)];
          ...
          plugins =
            [
               (`Extra, "META", Some "0.2.0~alpha1");
               (`Extra, "StdFiles", Some "0.2.0~alpha1");
               (`Extra, "DevFiles", Some "0.2.0~alpha1")
            ];
