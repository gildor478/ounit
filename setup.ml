...
(* OASIS_START *)
(* DO NOT EDIT (digest: e6bd3cf551db46682a902ec5062ecf9e) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Enable backtrace display in exception (deprecated).";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\1916\155\158\142\237\030\228RnW\145\004{\130\000";
     oasis_exec = None;
